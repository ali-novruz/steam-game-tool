...
function SocialShareSection({
  ...
  const socialText = [
    ...
    reviews.review_score_desc
      ...
      : "",
    game.metacritic
      ? `${game.metacritic.source === "opencritic" ? "OpenCritic" : "Metacritic"}: ${game.metacritic.score}/100`
      : "",
    `Price: ${priceText}`,
    "",
    storeLink,
      ...
      <Tabs defaultValue="twitter" className="w-full">
        ...
        <TabsContent value="twitter" className="flex flex-col gap-3 mt-3">
                  ...
                  >
                    {game.metacritic && (
                      ...
                      >
                        ...
                        >
                          {game.metacritic.source === "opencritic"
                            ? "OpenCritic"
                            : "Metacritic"}
                        </div>
                      </div>
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => handleDownload(twitterRef, "twitter")}
        ...
        <TabsContent value="instagram" className="flex flex-col gap-3 mt-3">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => handleDownload(instaRef, "instagram")}
        ...
        <TabsContent value="general" className="flex flex-col gap-3 mt-3">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => handleDownload(generalRef, "general")}
          ...
          >
            ...
            {downloading === "general"
              ? "..."
              : `${t(lang, "download")} ${t(lang, "shareGeneral")}`}
          </Button>
        </TabsContent>
      </Tabs>
    </div>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        {/* Hero Section - only shown when no game loaded */}
        {!gameData && !loading && !error && (
          <div className="flex flex-col items-center gap-12 py-12 md:py-20">
            ...
            >
              ...
              <div>
                <div className="text-2xl font-bold text-foreground md:text-3xl">
                  {lang === "tr" ? "Anlik" : "Instant"}
                </div>
                <div className="text-xs text-muted-foreground">
                  {lang === "tr" ? "Kesfet" : "Discovery"}
                </div>
              </div>
              <div className="h-8 w-px bg-border" />
              <div>
                ...
                <div className="text-xs text-muted-foreground">
                  {lang === "tr" ? "Paylasim Formati" : "Share Formats"}
                </div>
              </div>
            </div>
          </div>
